...
const ViewBankAccount = () => {
  ...
  const retrieveBankAccount = async () => {
    const response = await axios.get(
      `${process.env.REACT_APP_BASE_URL}/api/bank/account/fetch/user?userId=` + customer.id,
      {
        headers: {
  ...
  const downloadStatement = (e) => {
    ...
    fetch(
      `${process.env.REACT_APP_BASE_URL}/api/bank/transaction/statement/download?accountId=` +
        bankAccount.id +
        "&startTime=" +
  ...
  const depositAmount = (e) => {
    ...
    fetch(`${process.env.REACT_APP_BASE_URL}/api/bank/transaction/deposit`, {
      method: "POST",
      headers: {
  ...
  const withdrawAmount = (e) => {
    ...
    fetch(`${process.env.REACT_APP_BASE_URL}/api/bank/transaction/withdraw`, {
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
